  ...
  return (
    <div className="bg-[#0b1220] min-h-screen flex items-center justify-center p-4">
      <div className="bg-[#121a2b] p-8 rounded-xl shadow-lg w-full max-w-md space-y-6">
        <h1 className="text-3xl font-bold text-blue-400 text-center">Doctor Login</h1>
        ...
        <p className="text-center text-gray-400 text-sm">
          Don't have an account? <a href="/dsignup" className="text-blue-400 hover:underline">Sign Up</a>
        </p>
      </div>
    </div>
  );
