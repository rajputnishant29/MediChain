...
function Hlogin() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log("Hospital/Lab Login Data:", formData);
    ...
    <div className="bg-[#0b1220] min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative z-10 bg-[#121a2b] p-8 rounded-2xl shadow-2xl w-full max-w-md space-y-6 border border-gray-700">
        ...
        <div className="flex flex-col items-center space-y-3">
          ...
          <h1 className="text-3xl font-bold">Hospital / Lab Login</h1>
          <p className="text-gray-400 text-sm text-center">
            Access your secure MediChain hospital/lab dashboard
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <input
              ...
              placeholder="Enter email or Hospital/Lab ID"
